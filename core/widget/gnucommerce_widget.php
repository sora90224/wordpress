...
class sir_latest_board_widget extends SIR_COMM_Widget {
	...
	public function __construct() {
        ...
        */
		...
		$this->widget_description = __( '그누커머스 최신글 위젯입니다.', 'sir-furniture' );
		$this->widget_id          = 'sir_comm_latest';
		$this->widget_name        = __( '그누커머스 최신글 위젯', 'sir-furniture' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( '최신글', 'sir-furniture' ),
				'label' => __( '제목', 'sir-furniture' )
			),
			'rows' => array(
				'type'  => 'number',
				'step'  => 1,
			...
			'bo_table' => array(
				'type'  => 'select',
				'std'   => '',
				'label' => __( '출력할 게시판', 'sir-furniture' ),
				'options' => $board_array,
			),
			'skin_dir' => array(
				'type'  => 'select',
				'std'   => '',
				'label' => __( '스킨폴더', 'sir-furniture' ),
			...
			'row_mod' => array(
				...
				'max'   => 6,
				'std'   => 3,
				'label' => __( '이미지 스킨일 경우 한줄에 출력할 갯수 설정', 'sir-furniture' ),
			),
            'url'   => array(
                'type'  => 'text',
				'std'   => '',
                'label' => __( '주소( url )를 지정합니다.', 'sir-furniture' ),
            ),
			'subject_len' => array(
				'type'  => 'number',
				'step'  => 1,
				...
				'max'   => 40,
				'std'   => 40,
				'label' => __( '출력할 제목 길이', 'sir-furniture' ),
			),
			'content_len' => array(
				'type'  => 'number',
				'step'  => 1,
				...
				'max'   => 80,
				'std'   => 80,
				'label' => __( '출력할 내용 길이', 'sir-furniture' ),
			),
			'cache_time' => array(
				'type'  => 'number',
				'step'  => 1,
				...
				'max'   => '',
				'std'   => 1,
				'label' => __( '캐쉬사용( 미사용시 0으로 설정 )', 'sir-furniture' ),
			),
		);
