...
$row_mod = isset($row_mod) ? (int) $row_mod : 6;    //한줄에 출력할 이미지수
?>
<div class="sir_community_latest_gallery">
<h2 style="display:none"><a href="<?php echo esc_url( $gc_page_url ); ?>"><?php echo $bo_subject; ?></a></h2>
    ...
    foreach($list as $row) {
        ...
        if($thumb['src']) {     //이미지가 있을때
            ...
            $img_content = '<img src="'.get_template_directory_uri().'/img/no_img.png" class="thumb" alt="no image" >';
        }
    ?>
        <li class="<?php echo implode(' ', $classes); ?>">
            ...
            echo "<a href=\"".esc_url($row['href'])."\" class=\"new-title\">";
